                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="password"
                                                placeholder="mật khẩu" value="<?=$list1['password']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                placeholder="email" value="<?=$list1['email']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="avatar"
                                                placeholder="092231..." value="<?=$list1['avatar']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone"
                                                placeholder="092231..." value="<?=$list1['phone']?>">
                                        ...
                                        <div class="form-group">
                                            <label>địa chỉ</label>
                                            <input type="text" class="form-control" value="<?=$list1['address']?>" name="address"
                                                placeholder="địa chỉ" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nationality"
                                                placeholder="quốc tịch" value="<?=$list1['nationality']?>">
