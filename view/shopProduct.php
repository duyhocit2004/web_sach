                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="<?= BASE_URL . '?act=detail-product&id=' . $products['id'];?>">
                                                    <img class="pri-img" src="<?= BASE_URL . $products['image'] ?>"
                                                        alt="product">
                                                    <img class="sec-img" src="<?= BASE_URL . $products['image'] ?>"
                                                        alt="product">
                                                </a>
                                            ...
                                            <div class="product-caption text-center">
                                                ...
                                                <div class="price-box">
                                                    <span style="color: red"><?= formatPrice($products['price']) . 'đ'; ?>
                                                </div>
                                        ...
                                        <div class="product-list-item">
                                            ...
                                            <hlass="product-name">
                                                    ...
                                                    <div class="price-box">
                                                        <span
                                                            style="color: red"><?= formatPrice($products['price']) . 'đ'; ?>
                                                    </div>
                                                    <p <?= BASE_URL . $products['description']?>><?= $products['description']?></p>
                                            </div>
                                        </div>
                                        <!-- product list item end -->
                                    </div>
