...
<!-- Mirrored from gramentheme.com/html/bookle/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Sep 2024 21:25:56 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
...
<body>
    ...
    <!-- Login Modal -->
    <?php require_once "./view/auth/login.php" ?>
    
    <!-- Registration Modal -->
    <?php require_once "./view/auth/register.php"  ?>
                ...
                <div class="col-12 col-xl-8 col-lg-6">
                    <div class="hero-items">
                        ...
                        <div class="hero-content">
                            <h6 class="wow fadeInUp" data-wow-delay=".3s">Giảm giá lên đến 30% </h6>
                            <h1 class="wow fadeInUp" data-wow-delay=".5s">Mua sách mới của bạn <br> Với mức giá tốt nhất Mua ngay
                            </h1>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href=""><img src="assets/img/book/01.png" alt="img"></a>
                                <ul class="post-box">
                                    <li>
                                        Hot
                                    </li>
...
<!-- Mirrored from gramentheme.com/html/bookle/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Sep 2024 21:26:09 GMT -->
</html>