            ...
            <div class="header-top-wrapper">
                <ul class="contact-list">
                    ...
                    <li>
                        ...
                        <a href="mailto:info@example.com">Thegioisach@gmail.com</a>
                    </li>
                    <li>
                        <i class="far fa-clock"></i>
                        <span>thứ 2 - thứ 7 : 8h - 22h00</span>
                    </li>
                </ul>
                <ul class="list">
                            ...
                            <div class="header-left">
                                <div class="logo">
                                    <a href="index.html" class="header-logo">
                                        <img src="uploads/clients/logo/THế Giới sách-Photoroom.png" width="80px" alt="logo-img">Thế Giới Sách
                                    </a>
                                </div>
                            ...
                            <div class="header-left">
                                <div class="logo">
                                    <a href="index.html" class="header-logo d-flex">
                                        <img src="uploads/clients/logo/THế Giới sách-Photoroom.png" width="85px" alt="logo-img">
                                    </a>
                                    <p>THẾ GIỚI SÁCH</p>
                                </div>
                                <div class="mean__menu-wrapper">
