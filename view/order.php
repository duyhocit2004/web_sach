                            ...
                            <div class="order-summary-content">
                                ...
                                <div class="order-payment-method">
                                    ...
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="checkpayment" name="paymentmethod" value="3" class="custom-control-input" />
                                    ...
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="paypalpayment" name="paymentmethod" value="4" class="custom-control-input" />
                                                <label class="custom-control-label" for="">hệ thống thanh toán trực tuyến</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="paypalpayment" name="paymentmethod" value="5" class="custom-control-input" />
                                                <label class="custom-control-label" for="paypalpayment">thẻ quà tặng </label>
                                        </div>
                                    </div>
