                                                        ...
                                                        <form action="" method="post">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        ...
                                                                        <input type="text" id="first-name" name="name" value="<?= $firstname ?>" placeholder="First Name" disabled />
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        <label for="last-name" class="">tên</label>
                                                                        <input type="text" id="last-name"  name="user" value="<?= $lastname ?>"  placeholder="Last Name" disabled />
                                                                    </div>
                                                                </div>
                                                                    <div class="single-input-item">
                                                                        <label for="email" class="">Email</label>
                                                                        <input type="email" id="email"  name="email" value="<?=$account['email'] ?>"  placeholder="Email Address"  disabled />
                                                                    </div>
                                                                 <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        <label for="email" class="">quốc tịch</label>
                                                                        <select   disabled class="" name="nationality" id="">
                                                                            <option value="<?=$account['nationality'] ?>"> <?=$account['nationality'] ?></option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        ...
                                                                        <input type="text" id="" value="<?=$account['phone'] ?>" placeholder="phone" disabled />
                                                                    </div>
                                                                </div>
                                                                <div class="single-input-item">
                                                                        <label for="" class="">địa chỉ</label>
                                                                        <input type="email" id="" value="<?=$account['address'] ?>"  placeholder="address"  disabled />
                                                                </div>
                                                                <div class="single-input-item">
                                                                        <label for="" class="">avatar</label>
                                                                        <input type="file" id=""  placeholder="avatar"  disabled />
                                                                    </div>
                                                            </div>
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="single-input-item">
                                                                    ...
                                                                    <input type="password" id="current-pwd" name="password disabled" placeholder="Current Password" disabled />
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="single-input-item">
                                                                            <label for="new-pwd" class="required">mật khẩu mới</label>
                                                                            <input type="password" id="new-pwd"  placeholder="New Password" placeholder disabled />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="single-input-item">
                                                                            <label for="confirm-pwd" class="required">nhập lại mật khẩu</label>
                                                                            <input type="password" id="confirm-pwd"  placeholder="Confirm Password"  disabled/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </fieldset>
                                                            <div class="single-input-item">
                                                                <a class="btn btn-sqr" href="?act=editClients"> chỉnh sửa thông tin</a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
